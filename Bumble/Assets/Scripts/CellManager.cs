...
public class CellManager : MonoBehaviour {
    ...
    public GameObject cellCheck(Vector3 dir, bool reCheck)
    {
        ...
        RaycastHit hit;
        float maxRay = dir.z; dir.z = 0;
        if (Physics.Raycast(gameObject.transform.position, dir, out hit, maxRay))
        {
        ...
        {
            left = (GameObject)Instantiate(emptyCell, gameObject.transform.position + dir, Quaternion.identity);
            return emptyCell;
        }
    }
